...
def add_content_slide(prs, title, content_items):
    ...
    content_box = slide.shapes.add_textbox(
        Inches(0.8), Inches(1.2), Inches(8.4), Inches(5.8)
    )
...
def add_two_column_slide(prs, title, left_content, right_content):
    ...
    left_box = slide.shapes.add_textbox(
        Inches(0.5), Inches(1.2), Inches(4.5), Inches(5.8)
    )
    ...
    right_box = slide.shapes.add_textbox(
        Inches(5.2), Inches(1.2), Inches(4.3), Inches(5.8)
    )
...
# Slide 1: Title
add_title_slide(prs, "Universal Canary MCP Server", "BD Hackathon 2025-10")
...
add_content_slide(
    prs,
    "Demo Scenario #1: Quick Status Check",
    [
        "User Query:",
...
add_content_slide(
    prs,
    "Demo Scenario #2: Trend Analysis",
    [
        "User Query:",
...
add_content_slide(
    prs,
    "Demo Scenario #3: Multi-Parameter Correlation",
    [
        "User Query:",
